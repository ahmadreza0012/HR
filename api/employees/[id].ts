export default async function handler(req: any, res: any) {
  ...
  target.searchParams.set("path", `employees/${id}`);
  target.searchParams.set("method", req.method || "GET");
  try {
    const body = req.method === "GET" ? undefined : req.method === "DELETE" ? "{}" : typeof req.body === "string" ? req.body : JSON.stringify(req.body ?? {});
